...
import 'package:scool_table/DasturHaqida.dart';
import 'package:scool_table/O\'qituvchilar.dart';
import 'package:scool_table/Sozlamalar.dart';
        ...
        children: [
          ...
          ListTile(
            leading: IconButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => OpoylarJadvali()));
              },
          ...
          ListTile(
            leading: IconButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Sozlamalar()));
              },
